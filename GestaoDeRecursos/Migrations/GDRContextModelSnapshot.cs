...
namespace ERP.Migrations
{
    ...
    partial class GDRContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Models.EntityAvaliacao", b =>
                {
                    ...
                    b.Property<double>("AbdomenInfra")
                        .HasColumnType("float");

                    b.Property<double>("AbdomenSupra")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ERP.Models.EntityAgendamento", b =>
                {
                    b.HasOne("ERP.Models.EntityCliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("IdCliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Models.EntityDiaSemana", "DiaSemana")
                        .WithMany()
                        .HasForeignKey("IdDiaSemana")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Models.EntityEmpresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("IdEmpresa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Models.EntityPacote", "Pacotes")
                        .WithMany()
                        .HasForeignKey("IdPacote")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Models.EntityServicos", "Servico")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.Models.EntityDiaSemana", b =>
                {
                    ...
                    b.HasOne("ERP.Models.EntitySemana", "Semana")
                        .WithMany()
